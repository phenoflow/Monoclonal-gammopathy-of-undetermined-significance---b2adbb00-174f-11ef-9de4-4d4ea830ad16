...
(async () => {
  ...
  await fs.writeFile("monoclonal-gammopathy-of-undetermined-significance-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("monoclonal-gammopathy-of-undetermined-significance-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
